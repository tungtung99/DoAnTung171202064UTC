...
namespace ShopWatch.WebMvc.Controllers
{
    ...
    {        
        ...
        {
            return View(_commentServices.GetAll());
        }
        ...
        //public ActionResult Create([Bind(Include = "CommentId,Text,WatchId,AccountId,Likes,IsBuy")] Comment comment)
        //{
        ...
        //[HttpPost]
        //[ValidateAntiForgeryToken]
        //public ActionResult Edit([Bind(Include = "CommentId,Text,WatchId,AccountId,Likes,IsBuy")] Comment comment)
        //{
        //    if (ModelState.IsValid)
        //    {
